...
if __name__ == "__main__":
    ...
    # print("\n=== 示例1: 读取 PDF 文件 ===")
    # pdf_content = reader.read_file("../../test_files/11.pdf")
    ...
    #
    print("\n=== 示例4: 读取多种格式文件 ===")
    files = ["../../test_files/package.json", "../../test_files/角色毕业面板.xlsx", "../../test_files/圆桌会.md", "../../test_files/马克思.docx", "../../test_files/A Survey on RAG.pdf"]
